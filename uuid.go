...
var (
	...
	// NameSpace_DNS assume name to be a fully-qualified domain name.
	// Declared in RFC 4122 Appendix C.
	NameSpace_DNS = &UUID{
		0x6b, 0xa7, 0xb8, 0x10, 0x9d, 0xad, 0x11, 0xd1,
		0x80, 0xb4, 0x00, 0xc0, 0x4f, 0xd4, 0x30, 0xc8,
	}
	// NameSpace_URL assume name to be a URL.
	// Declared in RFC 4122 Appendix C.
	NameSpace_URL = &UUID{
		0x6b, 0xa7, 0xb8, 0x11, 0x9d, 0xad, 0x11, 0xd1,
		0x80, 0xb4, 0x00, 0xc0, 0x4f, 0xd4, 0x30, 0xc8,
	}
	// Namespace_OID assume name to be an ISO OID.
	// Declared in RFC 4122 Appendix C.
	NameSpace_OID = &UUID{
		0x6b, 0xa7, 0xb8, 0x12, 0x9d, 0xad, 0x11, 0xd1,
		0x80, 0xb4, 0x00, 0xc0, 0x4f, 0xd4, 0x30, 0xc8,
	}
	// Namespace_X500 assume name to be a X.500 DN (in DER or a text output format).
	// Declared in RFC 4122 Appendix C.
	NameSpace_X500 = &UUID{
